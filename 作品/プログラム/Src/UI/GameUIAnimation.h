...
public:
	// 各アニメーション再生
	static void PlayBlinkAnimation(GameUI* ui, float speed);
	static void PlayFloatingAnimation(GameUI* ui, float speed, float floating_size);
	static void PlaySlidingAnimation(GameUI* ui, VECTOR start_pos, VECTOR end_pos, float speed);
